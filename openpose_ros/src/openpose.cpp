...
OpenPose::OpenPose() : outputSize(op::flagsToPoint(op::String(FLAGS_output_resolution), "-1x-1")),
                       ...
                       wrapperStructPose(poseMode, netInputSize, FLAGS_net_resolution_dynamic, outputSize, keypointScaleMode, FLAGS_num_gpu, 
                                         FLAGS_num_gpu_start, FLAGS_scale_number, (float)FLAGS_scale_gap, op::flagsToRenderMode(FLAGS_render_pose, multipleView),
